...
describe("UCSBSubjectsIndexPage tests", () => {
    ...
    test("renders three subjects without crashing for regular user", async () => {
        ...
        await waitFor(() => { expect(getByTestId(`${testId}-cell-row-0-col-subjectCode`)).toHaveTextContent("ANTH"); });
        expect(getByTestId(`${testId}-cell-row-1-col-subjectCode`)).toHaveTextContent("CMPSC");
        expect(getByTestId(`${testId}-cell-row-2-col-subjectCode`)).toHaveTextContent("PHIL");
    });
